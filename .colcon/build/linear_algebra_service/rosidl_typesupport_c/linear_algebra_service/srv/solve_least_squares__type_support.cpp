...
static const _SolveLeastSquares_Request_type_support_symbol_names_t _SolveLeastSquares_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, linear_algebra_service, srv, SolveLeastSquares_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, linear_algebra_service, srv, SolveLeastSquares_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, linear_algebra_service, srv, SolveLeastSquares_Request)() {
  return &::linear_algebra_service::srv::rosidl_typesupport_c::SolveLeastSquares_Request_message_type_support_handle;
}
...
static const _SolveLeastSquares_Response_type_support_symbol_names_t _SolveLeastSquares_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, linear_algebra_service, srv, SolveLeastSquares_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, linear_algebra_service, srv, SolveLeastSquares_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, linear_algebra_service, srv, SolveLeastSquares_Response)() {
  return &::linear_algebra_service::srv::rosidl_typesupport_c::SolveLeastSquares_Response_message_type_support_handle;
}
...
static const _SolveLeastSquares_type_support_symbol_names_t _SolveLeastSquares_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, linear_algebra_service, srv, SolveLeastSquares)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, linear_algebra_service, srv, SolveLeastSquares)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, linear_algebra_service, srv, SolveLeastSquares)() {
  return &::linear_algebra_service::srv::rosidl_typesupport_c::SolveLeastSquares_service_type_support_handle;
}
